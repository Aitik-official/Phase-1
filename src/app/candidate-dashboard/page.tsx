    ...
    >
      ...
      <main className="mx-auto max-width[1200px] px-6 py-8">
        <div className="mx-auto max-w-7xl">
          ...
          {/* OLD SECTION TO BE REMOVED - Second Row: Profile Completion, CV Score, and Notifications */}
          < div className="flex items-start justify-center mb-6" style={{ display: "none" }}>
