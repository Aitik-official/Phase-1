              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {strengths.map((strength, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#EBF8FF] flex items-center justify-center mt-0.5">
                      <svg
            ...
            <ul className="space-y-4">
              {formattingSuggestions.map((suggestion, index) => (
                <li key={index} className="flex items-start gap-4 p-3 rounded-2xl bg-[#FFF5F5] border border-red-50">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white flex items-center justify-center shadow-sm">
                    <svg
